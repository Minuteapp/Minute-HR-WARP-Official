...
import { ChevronDown, ChevronUp, UserPlus, Users, Calendar, Clock, Target, TrendingUp, Sparkles } from 'lucide-react';
import IntelligentRecruitingTab from './intelligent/IntelligentRecruitingTab';

const RecruitingExpandableDashboard = () => {
  const [isExpanded, setIsExpanded] = useState(false);

  return (
    <div className="space-y-4">
      {/* Kompakte Dashboard-Ansicht */}
      ...
      {/* Erweiterbarer Bereich für intelligente Features */}
            ...
            <CardHeader className="cursor-pointer hover:bg-gray-50 transition-colors">
              <div className="flex items-center justify-between">
                <CardTitle className="flex items-center gap-2">
                  ...
                  Intelligente Recruiting-Features
                </CardTitle>
              ...
              {!isExpanded && (
                <p className="text-sm text-gray-600">
                  KI-gestützte Funktionen für Kandidaten-Matching, Interviewer-Vorschläge und mehr
                </p>
              )}
            </CardHeader>
          </CollapsibleTrigger>
...
export default RecruitingExpandableDashboard;
