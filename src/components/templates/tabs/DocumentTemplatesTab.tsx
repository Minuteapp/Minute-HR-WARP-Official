...
import { Eye, Edit, Copy, Trash2, Download, MoreVertical, FileText, Star } from 'lucide-react';
...
export const DocumentTemplatesTab = ({ searchTerm }: DocumentTemplatesTabProps) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h3 className="text-lg font-medium">Dokumenten-Templates</h3>
          <p className="text-sm text-gray-500">
            Vorlagen für Verträge, Zertifikate und rechtliche Dokumente
          </p>
        </div>
        <Button>
