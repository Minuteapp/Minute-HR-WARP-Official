...
INSERT INTO public.ai_suggestions (submitted_by, employee_name, department, suggestion_title, description, target_module, expected_benefit, use_case_type) VALUES
(auth.uid(), 'Max Mustermann', 'HR', 'KI-gestützte Bewerbungsauswertung', 'Automatische Vorauswahl von Bewerbungen basierend auf Stellenausschreibung', 'recruiting', 'Zeitersparnis von 60% bei der Bewerbungsauswertung', 'automation'),
(auth.uid(), 'Anna Schmidt', 'Finance', 'Automatische Budgetprognosen', 'KI-basierte Vorhersage von Budgetverläufen', 'budget', 'Genauere Finanzplanung, 25% weniger Budgetabweichungen', 'analysis');
