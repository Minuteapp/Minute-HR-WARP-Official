-- Erstelle Tabellen für das Roadmap-Modul (korrigierte Version)
...
-- RLS Policies für roadmaps (vereinfacht für den Start)
CREATE POLICY "Users can view all roadmaps" 
ON public.roadmaps 
FOR SELECT 
USING (true);
...
CREATE POLICY "Users can update roadmaps they created" 
ON public.roadmaps 
FOR UPDATE 
...
CREATE POLICY "Users can create milestones in roadmaps they can access" 
ON public.roadmap_milestones 
FOR INSERT 
WITH CHECK (
  roadmap_id IN (
...
CREATE POLICY "Users can create connections in their roadmaps" 
ON public.roadmap_connections 
FOR INSERT 
WITH CHECK (
  roadmap_id IN (
...
CREATE POLICY "Users can update connections in their roadmaps" 
ON public.roadmap_connections 
FOR UPDATE 
USING (
  roadmap_id IN (
...
CREATE POLICY "Users can delete connections in their roadmaps" 
ON public.roadmap_connections 
FOR DELETE 
USING (
  roadmap_id IN (
