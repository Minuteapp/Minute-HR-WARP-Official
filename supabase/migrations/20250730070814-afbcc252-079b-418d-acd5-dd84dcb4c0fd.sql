-- Innovation Hub Datenbank-Setup (korrigiert)

-- Tabelle für KI-Analyse von Innovationsideen
...
-- Trigger für automatische Timestamp-Updates erstellen falls nicht vorhanden
