...
ADD COLUMN IF NOT EXISTS ai_pros jsonb,
ADD COLUMN IF NOT EXISTS ai_cons jsonb,
ADD COLUMN IF NOT EXISTS ai_opportunities jsonb,
ADD COLUMN IF NOT EXISTS ai_benefits jsonb;
...
SET 
  ai_analysis_metadata = analysis.analysis_metadata,
