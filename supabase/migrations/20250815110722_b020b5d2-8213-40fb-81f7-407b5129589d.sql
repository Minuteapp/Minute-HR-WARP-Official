-- Performance-Optimierung für Enterprise-Skalierung (KORREKTE SPALTEN)
...
-- Prüfe ob time_entries existiert
DO $$
BEGIN
...
-- Korrigiere notification_queue Index (verwende korrekte Spalten)
CREATE INDEX IF NOT EXISTS idx_notifications_user_status 
ON notification_queue(user_id, status, created_at);
