-- Performance-Optimierung für Enterprise-Skalierung (OHNE ENUM)
...
-- 3. Bulk Operations für Enterprise-Verwaltung (ohne Enum)
...
-- 4. Pagination Helper für große Listen (ohne Enum)
