-- Create only missing tables and add the missing tickets table columns
...
CREATE TABLE IF NOT EXISTS public.kb_usage_logs (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_tickets_sla_due ON public.tickets(sla_due_at);
CREATE INDEX IF NOT EXISTS idx_tickets_created_at ON public.tickets(created_at);
CREATE INDEX IF NOT EXISTS idx_ticket_comments_ticket_id ON public.ticket_comments(ticket_id);
CREATE INDEX IF NOT EXISTS idx_faq_articles_category ON public.faq_articles(category_id);
CREATE INDEX IF NOT EXISTS idx_faq_articles_published ON public.faq_articles(is_published);