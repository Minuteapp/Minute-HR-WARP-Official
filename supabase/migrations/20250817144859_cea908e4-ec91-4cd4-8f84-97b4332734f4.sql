...
RETURNS TABLE (
    ...
    joining_date date,
    language_skills jsonb,  -- Fixed: should be jsonb not text[]
    personal_development_goals text,
    last_training_date date,
    last_promotion_date date,
    access_data jsonb,
    benefits jsonb,  -- Fixed: should be jsonb not text[]
    health_info jsonb,
    driver_license_class text,
    years_experience integer,
    security_clearance text,
    medical_checkups jsonb,
    active_memberships jsonb,  -- Fixed: should be jsonb not text[]
