-- Korrigiere die RLS-Policies und erstelle die erweiterte Spesenabrechnung
-- Zuerst prüfen wir die business_trip_expenses Struktur und korrigieren sie

-- Erweitere business_trip_expenses für umfassende Spesenabrechnung
...
INSERT INTO per_diem_rates (country_code, city_name, currency, full_day_rate, half_day_rate, accommodation_max, effective_from) VALUES
-- Deutschland (BMF 2024)
('DE', NULL, 'EUR', 28.00, 14.00, 150.00, '2024-01-01'),
('DE', 'München', 'EUR', 32.00, 16.00, 180.00, '2024-01-01'),
('DE', 'Hamburg', 'EUR', 30.00, 15.00, 170.00, '2024-01-01'),
('DE', 'Berlin', 'EUR', 30.00, 15.00, 170.00, '2024-01-01'),
('DE', 'Frankfurt am Main', 'EUR', 32.00, 16.00, 180.00, '2024-01-01'),
-- Österreich
('AT', NULL, 'EUR', 26.40, 13.20, 120.00, '2024-01-01'),
('AT', 'Wien', 'EUR', 30.00, 15.00, 150.00, '2024-01-01'),
('AT', 'Salzburg', 'EUR', 28.00, 14.00, 140.00, '2024-01-01'),
-- Schweiz
('CH', NULL, 'CHF', 65.00, 32.50, 220.00, '2024-01-01'),
('CH', 'Zürich', 'CHF', 80.00, 40.00, 280.00, '2024-01-01'),
('CH', 'Genf', 'CHF', 78.00, 39.00, 270.00, '2024-01-01')
ON CONFLICT (country_code, city_name, effective_from) DO NOTHING;

-- Füge Standard-Kilometerpauschalen hinzu
INSERT INTO mileage_rates (country_code, vehicle_type, rate_per_km, currency, effective_from) VALUES
-- Deutschland
('DE', 'car', 0.30, 'EUR', '2024-01-01'),
('DE', 'motorcycle', 0.20, 'EUR', '2024-01-01'),
('DE', 'bicycle', 0.05, 'EUR', '2024-01-01'),
-- Österreich
('AT', 'car', 0.42, 'EUR', '2024-01-01'),
('AT', 'motorcycle', 0.24, 'EUR', '2024-01-01'),
('AT', 'bicycle', 0.05, 'EUR', '2024-01-01'),
-- Schweiz
('CH', 'car', 0.70, 'CHF', '2024-01-01'),
('CH', 'motorcycle', 0.35, 'CHF', '2024-01-01'),
('CH', 'bicycle', 0.10, 'CHF', '2024-01-01')
...
DROP TRIGGER IF EXISTS expense_audit_trigger ON business_trip_expenses;
