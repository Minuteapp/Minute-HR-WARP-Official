-- Prüfe zuerst die Struktur der user_roles Tabelle
-- und füge den SuperAdmin-Eintrag ohne CONFLICT-Klausel hinzu
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE user_id = 'a039669c-69f0-446b-9487-1c2d447c89ae' 
        AND role = 'superadmin'
    ) THEN
