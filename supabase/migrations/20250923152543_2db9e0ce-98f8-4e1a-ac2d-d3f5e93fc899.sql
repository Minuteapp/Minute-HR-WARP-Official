-- KRITISCHE SICHERHEITSFUNKTION REPARATUR
-- Problem: is_superadmin_safe versucht auf auth.users zuzugreifen (nicht erlaubt)

-- 1. Sicherheitsfunktion is_superadmin_safe korrigieren
...
-- 2. Zusätzliche sichere Funktionen für bessere Performance
...
-- 3. Tenant-Context Funktionen absichern
