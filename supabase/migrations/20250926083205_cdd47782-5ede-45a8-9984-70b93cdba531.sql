-- SICHERHEITSREPARATUR TEIL 8: Weitere kritische Funktion reparieren
-- create_company Funktion härten

CREATE OR REPLACE FUNCTION public.create_company(p_name text, p_address text, p_billing_email text, p_phone text, p_website text, p_subscription_status text, p_tax_id text, p_vat_id text, p_contact_person text)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
