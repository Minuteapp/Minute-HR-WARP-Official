-- Korrigierte Funktion für Krankmeldungs-Benachrichtigungen
-- Liest manager_id jetzt aus employees statt profiles Tabelle
...
BEGIN
  ...
  -- Finde zuständigen Manager aus employees Tabelle (NICHT profiles!)
