-- Funktion mit korrektem Cast für employment_type Enum
...
BEGIN
  ...
  -- Cast employment_type sicher
  BEGIN
    v_employment_type := COALESCE(p_employment_type, 'full_time')::employment_type;
  EXCEPTION WHEN OTHERS THEN
    v_employment_type := 'full_time'::employment_type;
  END;
  ...
  INSERT INTO employees (
    ...
    p_employee_number, v_employment_type, p_start_date, COALESCE(p_onboarding_required, false), p_birth_date,
